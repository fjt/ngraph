...
optflags = -O3 -fno-fast-math -DWITHGRAPE
debugflags = -ggdb3
...
ldflags  = -L. -Wl,-z,relro -L/build/ruby2.3-TAju0T/ruby2.3-2.3.3/debian/lib -fstack-protector -rdynamic -Wl,-export-dynamic
dldflags =  
ARCH_FLAG = 
...
libpath = . $(archlibdir)
LIBPATH =  -L. -L$(archlibdir) -L.. -L../../../pg5
DEFFILE = 
...
$(DLLIB): $(OBJS) Makefile
	...
	-$(Q)$(RM) $(@)
	$(Q) $(LDSHARED) -o $@ $(OBJS) $(LIBPATH) $(DLDFLAGS) $(LOCAL_LIBS) $(LIBS) -lpg55 -fopenmp
